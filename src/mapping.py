...
CAMERA_HIGH = 300
HAND_HIGH = 50 # Estimatation

FIELD_X_MM = (MAX_FIELD_X_MM / 2) * (CAMERA_HIGH - HAND_HIGH) / CAMERA_HIGH * 2
FIELD_Y_MM = (MAX_FIELD_Y_MM / 2) * (CAMERA_HIGH - HAND_HIGH) / CAMERA_HIGH * 2
